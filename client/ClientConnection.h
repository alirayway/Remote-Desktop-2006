...
#define SETTINGS_KEY_NAME "Software\\ORL\\rdviewer\\Settings"
...
{
public:
	ClientConnection(rdviewerApp *pApp);
	ClientConnection(rdviewerApp *pApp, SOCKET sock);
	ClientConnection(rdviewerApp *pApp, LPTSTR host, int port);
	ClientConnection(rdviewerApp *pApp, LPTSTR configFile);
